...
def main():
    ...
    for filename in glob.glob(IMAGE_PATH + '/*.jpg'):        
        ...
        print("Load Image :", filename, ", Scores :", round(detections['detection_scores'][0], 3))
...
#             # print(kordinat) 
        ...
        cv2.imshow("Image Detection", cv2.resize(cv2.cvtColor(image_np_with_detections, cv2.COLOR_BGR2RGB), (800,600)))
        # cv2.imshow("Image Detection", cv2.resize((800,600)))
        cv2.waitKey(0)
